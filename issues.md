...
## ОС по работе с перечнем ошибок и доработок (не исправлено на 25.01.26)
...
settings.Item[int]{Name: “PASSWORD_COST”, Default: bcrypt.DefaultCost, Field: &c.MinLength}, // должно быть &c.Cost
